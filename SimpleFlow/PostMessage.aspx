<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostMessage.aspx.cs" Inherits="SimpleFlow.PostMessage" %>
...
<body>
    ...
    <div class="row" style="height:50px; margin-left:100px; margin-top:50px;">
        <legend>Write a message that will be posted in your Wall</legend>
    </div>
