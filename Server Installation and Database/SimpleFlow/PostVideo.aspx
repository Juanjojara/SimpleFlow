<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostVideo.aspx.cs" Inherits="SimpleFlow.PostVideo" %>
...
<body>
    ...
    <div class="row" style="height:50px; margin-left:100px; margin-top:50px;">
        <legend>Upload a video to the album of the application</legend>
    </div>
    <div class="control-group">
        <label class="control-label" for="inputMsg">Select a video to upload</label>
        <div class="controls">
